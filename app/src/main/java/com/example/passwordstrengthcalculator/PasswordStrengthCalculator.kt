...
class PasswordStrengthCalculator : TextWatcher {
    ...
    override fun onTextChanged(char: CharSequence?, p1: Int, p2: Int, p3: Int) {
        if (char != null) {
            ...
            Log.d("lower", lowerCase.value.toString())
            Log.d("upper", lowerCase.value.toString())
            Log.d("digit", lowerCase.value.toString())
            Log.d("specialChar", lowerCase.value.toString())
        }
    }
